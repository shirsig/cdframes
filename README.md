...
**/cdframes frame focus pfUI and pfUI.uf and pfUI.uf.focus and pfUI.uf.focus.unitname and gsub(pfUI.uf.focus.unitname, '^%l', strupper)** (adds a frame for focus of [pfUI](https://github.com/shagu/pfUI))<br/>
